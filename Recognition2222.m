...
matrixglasses = zeros(896*592*3,50);
scrfile=dir('D:\project\data 1\*.jpg');
 for i=1:length(scrfile)
    filename=strcat('D:\project\data 1\',scrfile(i).name);
    x=imread(filename);
    matrixglasses (:,i) = reshape(x,896*592*3,1);
